...
public class GameManager {
	...
	private final void createButtons() {
		JLabel pongLabel = new JLabel(), tttLabel = new JLabel(), closeLabel = new JLabel(), minimize = new JLabel(),
				layout = new JLabel();
		...
		pongLabel.setBounds(10, 11, 176, 70);
		tttLabel.setBounds(10, 92, 319, 60);
		closeLabel.setBounds(565, 11, 25, 25);
		minimize.setBounds(530, 11, 25, 25);
		layout.setBounds(0, 0, 600, 400);

		pongLabel.setIcon(pongImg);
		tttLabel.setIcon(tttImg);
		closeLabel.setIcon(closeImg);
		minimize.setIcon(minimizeImg);
		layout.setIcon(Utils.getBlack(600, 400));

		frame.getContentPane().add(pongLabel);
